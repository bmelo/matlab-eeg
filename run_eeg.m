...
for subjN = config.subjs
    ...
    plot_overlap_task(EEG_pow, 'power', chs, 0, extra, @erd_ers, EEG.srate, floor(EEG.srate/5));
    ...
    plot_bands_overlap_task(bEEG_erd, 'ERD-ERS', chs, 0, extra, @erd_ers, bEEG(1).srate, floor(bEEG(1).srate/5));
